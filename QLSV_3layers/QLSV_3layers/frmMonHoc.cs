...
namespace QLSV_3layers
{
    public partial class frmMonHoc : Form
    {
        ...
        {
            if(string.IsNullOrEmpty(mamh)) // nếu không có mã môn học truyền vào thì sẽ là thêm mới môn học
            {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Số tín chỉ không đúng");
                txtSoTC.Select();
                return;
            }
            ...
            string sql = "";
            List<CustomParameter> lstPara = new List<CustomParameter>(); // Khai báo LstPara để truyền tham số vào
            ...
            if(rs == 1) // kiểm tra có thực thi thành công hay không 
            {
                if(string.IsNullOrEmpty(mamh))
                {
