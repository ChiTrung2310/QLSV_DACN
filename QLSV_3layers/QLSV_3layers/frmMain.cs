...
namespace QLSV_3layers
{
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            if (taikhoan != "") // nếu có nhập tài khoản thì mới thực hiện các lệnh ở trong còn nếu không thì thoát
            {
        ...
        private void AddForm(Form f) // dùng để điều chỉnh form khi hiện lên theo ý muốn
        {
