    ...
    public partial class frmSinhVien : Form
    {
        ...
        private void frmSinhVien_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //msv là mã sinh viên đã được truyền từ form danh sách sinh viên
                ...
                if(int.Parse(r["gioitinh"].ToString()) == 1) // hiển thị giới tính theo định dạng nam và nữ
                {
                    rbtNam.Checked = true;
                }
                else
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            //khai báo một danh sách tham sô = class CustomParameter -> đã được khai báo ở class CustomParameter
        ...
        /// <summary>
        /// Thoát hoàn toàn form Sinh Viên
        /// </summary>
        ...
        /// <summary>
        /// Khi thực hiện xóa sinh viên
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnXoa_Click(object sender, EventArgs e)
        {
            //  Xác nhận lại 1 lần trước khi xóa sinh viên
            if (
                    DialogResult.Yes ==
                    MessageBox.Show(
                                    "Bạn muốn xóa sinh viên [" + txtHo.Text + txtTendem.Text + txtTen.Text + "]?",
                 ...
                 )
            {
                ...
                List<CustomParameter> lstPara = new List<CustomParameter>();
                if (string.IsNullOrEmpty(msv))//nếu không có mã sinh viên
                {
                    MessageBox.Show("Không có dữ liệu mã sinh viên");
                }

                else//nếu xóa sinh viên thì thực hiện những câu lệnh tiếp theo sau
                {
                    sql = "deleteSV";//gọi tới procedure xóa sinh viên
                    lstPara.Add(new CustomParameter()
                    {
                        key = "@masinhvien",
                        value = msv
                    ...
                    if (rs == 1)//nếu thực hiện thành công
                    {
                        if (string.IsNullOrEmpty(msv))//nếu không có dữ liệu truyền vào là mã sinh viên
                        {
                        ...
                        this.Dispose();//đóng form sau khi xóa sinh viên thành công
                    }
                    else//nếu không thành công
                    {
                        MessageBox.Show("Thực thi thất bại");
