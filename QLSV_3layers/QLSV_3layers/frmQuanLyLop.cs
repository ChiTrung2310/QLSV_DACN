...
namespace QLSV_3layers
{
    public partial class frmQuanLyLop : Form
    {
        ...
        {
            //trước đó chúng ta đã load được các thông tin tổng quan của lớp học phần do 1 giáo viên giảng dạy cụ thể
            //như là : mã lớp, mã học phần, tên học phần, số tín chỉ, sĩ số của lớp

            //ý tưởng của phần xử lý này:
            ...
            //như thiết kế csdl, dữ liệu truyền vào cần có mã lớp học -> truyền mã lớp được chọn từ form frmQuanLyLop qua form frmChamDiem
